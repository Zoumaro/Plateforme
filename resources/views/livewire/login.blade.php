...
<<<<<<< HEAD
=======
<div class="relative overflow-hidden rounded-lg bg-cover bg-no-repeat p-12" style="background-image: url('/image/HD.jpg'); height: 700px">
  <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed" style="background-color: rgba(0, 0, 0, 0.6)">
>>>>>>> 1cbe9cc358d1a55b17ab9d3c5d8e25773b77a786
